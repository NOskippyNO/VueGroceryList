...
<template>
  <main>
    ...
    <h3>Pending Grocery Count: {{groceries.length }}</h3>
    <ul>
...
<style lang="postcss" scoped>
  main {
    @apply mt-8 flex flex-col justify-center items-center gap-5;

    .title {
    @apply m-2 text-5xl font-light tracking-wider text-purplish;
    }
    ...
    ul{
      ...
      li{
        @apply bg-white text-background m-3 p-2 w-96 text-center;
        &:hover {
          @apply bg-redish font-bold cursor-pointer;
        }
      }
    }
  }
